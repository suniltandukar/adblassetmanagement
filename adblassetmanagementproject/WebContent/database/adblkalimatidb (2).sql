...
(202, '9991', 'Ramkalimati', 'Ramkalimati', NULL, '#nav1, #nav2, #nav3, #nav4, #nav5, #nav6, #nav7, #nav8, #nav9, #nav10, #nav11, #nav12, #nav13, #nav14, #change, #remove', '', '', ''),
(203, '4342', 'tika', 'tika', NULL, '#nav1, #nav2, #nav3, #nav4, #nav5, #nav6, #nav7, #nav8, #nav9, #nav10, #nav11, #nav12, #nav13, #nav14, #change, #remove', '', '', ''),
(204, '8880', 'yui', 'yui', NULL, '#nav1, #nav2, #nav3, #nav4, #nav5, #nav6, #nav7, #nav8, #nav9, #nav10, #nav11, #nav12, #nav13, #nav14, #change, #remove', '', '', ''),
(205, '133', 'tt', 'tt', NULL, '#nav1, #nav2, #nav3, #nav4, #nav5, #nav6, #nav7, #nav8, #nav9, #nav10, #nav11, #nav12, #nav13, #nav14, #change, #remove', '2012-02-02', '2012-08-02', NULL),
(206, '95', 'nal', 'nal', NULL, '#nav2, #nav10', '2012-02-02', '2018-02-02', NULL),
(207, '425', 'tandhu', 'tandhu', NULL, '#nav1, #nav2, #nav3, #nav4, #nav5, #nav6, #nav7, #nav8, #nav9, #nav10, #nav11, #nav12, #nav13, #nav14, #change, #remove', '2012-02-02', '2018-02-02', NULL),
(208, '63', 'popp', 'popp', NULL, '#nav1, #nav2, #nav3, #nav4, #nav5, #nav6, #nav7, #nav8, #nav9, #nav10, #nav11, #nav12, #nav13, #nav14, #change, #remove', '2012-02-02', '2018-02-02', NULL),
(209, '444', 'kkk', 'kkk', NULL, '#nav1, #nav2, #nav3, #nav4, #nav5, #nav6, #nav7, #nav8, #nav9, #nav10, #nav11, #nav12, #nav13, #nav14, #change, #remove', '2012-02-02', '2018-02-02', NULL),
(210, '546', 'poi', 'poi', NULL, '#nav1, #nav2, #nav3, #nav4, #nav5, #nav6, #nav7, #nav8, #nav9, #nav10, #nav11, #nav12, #nav13, #nav14, #change, #remove', '2012-02-02', '2018-06-06', NULL),
(211, '92', 'arm', 'arm', NULL, '#nav1, #nav2, #nav3, #nav4, #nav5, #nav6, #nav7, #nav8, #nav9, #nav10, #nav11, #nav12, #nav13, #nav14, #change, #remove', '2015-02-02', '2016-02-06', NULL),
(212, '20', 'tara', 'tara', 1, '#nav1, #nav2, #nav3, #nav4, #nav5, #nav6, #nav7, #nav8, #nav9, #nav10, #nav11, #nav12, #nav13, #nav14, #change, #remove', '2012-02-02', '2015-02-02', NULL),
(213, '21', 'sandyp', 'sandyp', 1, '#nav1, #nav2, #nav3, #nav4, #nav5, #nav6, #nav7, #nav8, #nav9, #nav10, #nav11, #nav12, #nav13, #nav14, #change, #remove', '2012-02-02', '2018-02-02', NULL),
(214, '26', 'una', 'una', 1, '#nav1, #nav2, #nav3, #nav4, #nav5, #nav6, #nav7, #nav8, #nav9, #nav10, #nav11, #nav12, #nav13, #nav14, #change, #remove', '2012-02-02', '2012-02-02', NULL),
(215, '27', 'umesh', 'umesh', 1, '#nav1, #nav2, #nav3, #nav4, #nav5, #nav6, #nav7, #nav8, #nav9, #nav10, #nav11, #nav12, #nav13, #nav14, #change, #remove', '2012-00-02', '2018-02-02', NULL),
(216, '35', 'sun', 'sun', 1, '#nav1, #nav2, #nav3, #nav4, #nav5, #nav6, #nav7, #nav8, #nav9, #nav10, #nav11, #nav12, #nav13, #nav14, #change, #remove', '2012-02-02', '2018-02-02', NULL),
(217, '36', 'maile', 'maile', 1, '#nav1, #nav2, #nav3, #nav4, #nav5, #nav6, #nav7, #nav8, #nav9, #nav10, #nav11, #nav12, #nav13, #nav14, #change, #remove', '2012-02-02', '2018-02-02', NULL),
(218, '37', 'rama', 'rama', 1, '#nav1, #nav2, #nav3, #nav4, #nav5, #nav6, #nav7, #nav8, #nav9, #nav10, #nav11, #nav12, #nav13, #nav14, #change, #remove', '2012-02-02', '2018-02-02', NULL),
(219, '39', 'kanata', 'kanata', 2, '#nav1, #nav2, #nav3, #nav4, #nav5, #nav6, #nav7, #nav8, #nav9, #nav10, #nav11, #nav12, #nav13, #nav14, #change, #remove', '2012-20-20', '2012-02-02', NULL),
(220, '40', 'anil', 'anil', 2, '#nav1, #nav2, #nav3, #nav4, #nav5, #nav6, #nav7, #nav8, #nav9, #nav10, #nav11, #nav12, #nav13, #nav14, #change, #remove', '2012-02-02', '2018-02-02', NULL),
(221, '41', 'mike', 'mike', 2, '#nav1, #nav2, #nav3, #nav4, #nav5, #nav6, #nav7, #nav8, #nav9, #nav10, #nav11, #nav12, #nav13, #nav14, #change, #remove', '2012-02-02', '2018-02-02', NULL),
(222, '43', 'sujan', 'sujan', 1, '#nav1, #nav2, #nav10', '2012-02-02', '2018-02-02', NULL),
(223, '44', 'maka', 'maka', 1, '#nav1, #nav2, #nav3, #nav10', '2012-02-02', '2018-02-02', NULL),
(224, '45', 'karki', 'karki', 2, '#nav1, #nav2, #nav3, #nav4, #nav5, #nav6, #nav7, #nav8, #nav9, #nav10, #nav11, #nav12, #nav13, #nav14, #change, #remove', '2012-02-02', '2018-02-02', NULL),
(225, '46', 'rupesh', 'rupesh', 2, '#nav1, #nav2, #nav3', '2012-02-02', '2018-02-02', NULL);
...
--
ALTER TABLE `amctbl`
  MODIFY `amcid` bigint(20) NOT NULL AUTO_INCREMENT,AUTO_INCREMENT=18;
--
...
--
ALTER TABLE `insurancetbl`
  MODIFY `insuranceid` bigint(20) NOT NULL AUTO_INCREMENT,AUTO_INCREMENT=18;
--
-- AUTO_INCREMENT for table `inventoryotherdetailtbl`
--
ALTER TABLE `inventoryotherdetailtbl`
  MODIFY `inventoryotherdetailid` bigint(20) NOT NULL AUTO_INCREMENT,AUTO_INCREMENT=18;
--
...
--
ALTER TABLE `usertbl`
  MODIFY `userid` bigint(20) NOT NULL AUTO_INCREMENT,AUTO_INCREMENT=226;
--
-- AUTO_INCREMENT for table `warrantytbl`
--
ALTER TABLE `warrantytbl`
  MODIFY `warrantyid` bigint(20) NOT NULL AUTO_INCREMENT,AUTO_INCREMENT=195;
--
