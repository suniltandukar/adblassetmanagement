							...
							<tr>
								...
								<td><div class="dropdown">
										...
										<ul class="dropdown-menu">
											<li><a
												href="view/uploadedbills/<%=bill.getString("billimageoriginalname") %>"
												>View Bill</a></li>
											<li><a href="#" class="thumbnail img-responsive"
												data-toggle="modal" data-caption="test caption text"
												...
												data-target="#trslphotos"><img
													...
													alt="recent photo" width="0px" style="display: hidden;">Show</a></li>
											<li><a href="#" data-toggle="modal"
												data-target="#modalRegister" id="view"> Register</a></li>
										</ul>
									</div></td>
							</tr>
		...
		<div class="modal-dialog">
			<div class="modal-content">
				<div class="modal-body">
					...
					<img src="view/uploadedbills/${billimageoriginalname }"
