                                        ...
                                        <tr>
                                            <td>
                                                ...
                                                <select class="form-control" name="groupcode" form="form" required>
                                                	<option value="<%=idetail.getString("groupcode") %>" selected><%=idetail.getString("groupname") %></option>
                                                	<%while(group.next()){ %>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            ...
                                            <%while(companylist1.next()){ %>
                                                <option value="<%=companylist1.getString("companyid") %>" <%if(companylist1.getString("companyid").equals(idetail.getString("amccompanyid"))) {%>selected<%} %>><%=companylist1.getString("companyname") %></option>
                                            <%} %>
