                                    ...
                                    <tbody>
                                        <tr>
                                            ...
                                            <td>
                                                ...
                                                class="form-control"  form="form" value="<%=idetail.getString("itemcode") %>" readonly required>
                                            </td>
                                            <td>
                                        ...
                                        <tr>
                                            <td>
                                                <h5>Group Name</h5>
                                                <input type="text" class="form-control" name="groupcode" form="form" value="<%=idetail.getString("groupname") %>">
                                            </td>
                                            <td>
                                                <h5>Item name</h5> <input type="text" name="itemname"
                                                class="form-control"  form="form" value="<%=idetail.getString("itemname")%>" required>
                                            </td>
                                            <td>
                                        ...
                                        <tr>
                                            <td>
                                                ...
                                                placeholder="YYYY-MM-DD"  form="form" value="<%=idetail.getString("purchasedate") %>" required> 
                                            </td>
                                            <td>
                                                <h5>Purchase Date (A.D.)</h5> <input type="text"
                                                name="purchasedateen" class="form-control" id="englishDate2"
                                                placeholder="YYYY-MM-DD"  form="form" value="<%=idetail.getString("purchasedateen") %>" required>
                        ...
                        <div id="2" class="tab-pane fade in">
                            <table class="table" style="width: 80%;">
                                <tbody>
                                	<tr>
                                		<td>
                                            <h5>Supplier</h5> <input type="text" class="form-control"
                                            name="supplierid"  form="form" value="<%=idetail.getString("companyname") %>">
                                        </td>
                                		<td>
                                            <h5>Fund Source</h5> <input type="text" class="form-control"
                                            name="fundsource"  form="form" value="<%=idetail.getString("sourcename") %>">
                                        </td>
                                        <td>
                                            <h5>Item Condition</h5> <input type="text" name="itemconditionid"
                                            class="form-control"  form="form" value="<%=idetail.getString("itemconditionname") %>" >
                                        </td>
                                	</tr>
                                    <tr>
                                        ...
                                        <td>
                                            ...
                                            class="form-control" form="form" value="<%=idetail.getString("unitname")%>"><br>
                                        </td>
                                        <td>
                                            <h5>Item Size</h5> <input type="text" name="itemsize"
                                            class="form-control"  form="form" value="<%=idetail.getString("itemsize")%>">
                                        </td>
                                    </tr>
                                    <tr>
                                        <td>
                                ...
                                <tbody>
                                    <tr>
                                        <td>
                                            ...
                                            class="form-control" placeholder="YYYY-MM-DD"  form="form" id="nepaliDate3" value="<%=idetail.getString("amcstart") %>">
                                        </td>
                                        <td>
                                            <h5>AMC Start (A.D.)</h5> <input type="text"
                                            name="amcstarten" class="form-control"
                                            placeholder="YYYY-MM-DD"  form="form" id="englishDate3" value="<%=idetail.getString("amcstarten")%>">
                                        </td>
                                    </tr>
                                    <tr>
                                        <td>
                                            <h5>AMC End (B.S.)</h5> <input type="text" name="amcend"
                                            class="form-control" placeholder="YYYY-MM-DD"  form="form" id="nepaliDate4" value="<%=idetail.getString("amcend")%>">
                                        </td>
                                        <td>
                                            <h5>AMC End (A.D.)</h5> <input type="text" name="amcenden"
                                            class="form-control" placeholder="YYYY-MM-DD"  form="form" id="englishDate4" value="<%=idetail.getString("amcenden")%>">
                                        </td>
                                    </tr>
                                    <tr>
                                        <td>
                                            <h5>AMC Cost</h5> <input type="text" name="amccost"
                                            class="form-control"  form="form" value="<%=idetail.getString("amccost") %>">
                                        </td>
                                        <td>
                                            <h5>Company Name</h5> <input class="form-control"
                                            name="amccompanyid" form="form" value="<%=idetail.getString("amccompanyname") %>">
                                        </td>
                                    </tr>
                                </tbody>
                            </table>
                                ...
                                <tbody>
                                    <tr>
                                        <td>
                                            ...
                                            placeholder="YYYY-MM-DD"  form="form" value="<%=idetail.getString("insurancestart") %>">
                                        </td>
                                        <td>
                                            <h5>Insurance Start (A.D.)</h5> <input type="text"
                                            name="insurancestarten" class="form-control" id="englishDate5"
                                            placeholder="YYYY-MM-DD"  form="form" value="<%=idetail.getString("insurancestarten") %>">
                                        </td>
                                    </tr>
                                    <tr>
                                        <td>
                                            ...
                                            placeholder="YYYY-MM-DD"  form="form" value="<%=idetail.getString("insuranceend") %>">
                                        </td>
                                        <td>
                                            <h5>Insurance End (A.D.)</h5> <input type="text"
                                            name="insuranceenden" class="form-control" id="englishDate6"
                                            placeholder="YYYY-MM-DD"  form="form" value="<%=idetail.getString("insuranceenden") %>">
                                        </td>
                                    </tr>
                                    <tr>
                                        <td>
                                        ...
                                        <td>
                                            ...
                                            name="insurancecompanyid"  form="form">
                                                ...
                                                <option value="<%=companylist2.getString("companyid") %>" <%if(companylist2.getString("companyid").equals(idetail.getString("insurancecompanyid"))) {%>selected<%} %>><%=companylist2.getString("companyname") %></option>
                                            <%} %>
                                        </select>
                                        </td>
                                    </tr>
                                ...
                                <tbody>
                                    <tr>
                                        <td>
                                            ...
                                            class="form-control" form="form" placeholder="YYYY-MM-DD" id="nepaliDate7" value="<%=idetail.getString("warrantystart") %>">
                                        </td>
                                        
                                        <td>
                                            <h5>Warranty Start (A.D.)</h5> <input type="text" name="warrantystarten"
                                            class="form-control" form="form" placeholder="YYYY-MM-DD" id="englishDate7" value="<%=idetail.getString("warrantystarten") %>">
                                        </td>
                                        </tr>
                                        <tr>
                                        <td>
                                            <h5>Warranty End (B.S.)</h5> <input type="text" name="warrantyend"
                                            class="form-control" form="form" placeholder="YYYY-MM-DD" id="nepaliDate8" value="<%=idetail.getString("warrantyend") %>">
                                        </td>
                                         <td>
                                            <h5>Warranty End (A.D.)</h5> <input type="text" name="warrantyenden"
                                            class="form-control"  form="form" placeholder="YYYY-MM-DD" id="englishDate8" value="<%=idetail.getString("warrantyenden") %>">
                                        </td>
                                                                            </tr>
                                </tbody>
                            </table>
                                ...
                                <tbody>
                                    <tr>
                                        <td>
                                            ...
                                            class="form-control" form="form" value="<%=idetail.getString("vehicleno") %>">
                                        </td>
                                         <td>
                                            <h5>Chesisno</h5> <input type="text" name="chesisno"
                                            class="form-control"  form="form" value="<%=idetail.getString("chesisno") %>">
                                        </td>
                                        <td>
                                            <h5>Engine No.</h5> <input type="text" name="engineno"
                                            class="form-control" form="form" value="<%=idetail.getString("engineno") %>">
                                        </td>
                                    </tr>
                                </tbody>
                            </table>
                                ...
                                <tbody>
                                    <tr>
                                        <td>
                                            ...
                                            class="form-control" form="form" value="<%=idetail.getString("licenseno") %>">
                                        </td>
                                    </tr>
                                </tbody>
                            </table>
                                ...
                                <tbody>
                                    <tr>
                                        <td>
                                            ...
                                            class="form-control" form="form" value="<%=idetail.getString("macaddress")%>">
                                        </td>
                                    </tr>
                                </tbody>
                            </table>
